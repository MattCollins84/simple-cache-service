module.exports = function(credentials) {
  ...
  var hostname = credentials.hostname,
      port = credentials.port? parseInt(credentials.port) : null,
      password = (credentials.auth)? credentials.auth.split(':')[1] : null,
      client = require("redis").createClient(port, hostname, { auth_pass: password});
